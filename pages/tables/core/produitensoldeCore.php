...
class ProduitensoldeCore 
{
	...
	{
		$sql="insert into produitensolde (reference,nom,prix,description,photo,type,remise,nouvprix) values (:reference, :nom,:prix,:description,:photo, :type, :remise, :nouvprix)";
        ...
        $nouvprix=$produitensolde->getNouvprix();
        ...
        $req->bindValue(':nouvprix',$nouvprix);
